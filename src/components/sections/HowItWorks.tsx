    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-8 md:space-y-0 md:relative md:overflow-hidden md:min-h-[400px] mb-4">
          ...
          {/* Investors Content */}
          {renderContent(investorsContent, currentTab === "For Investors", "right")}
          {renderContent(organisationContent, currentTab === "For Organisation", "right")}
        </div>
      </div>
    </motion.section>
  );
...
const renderContent = (content: Content[], isActive: boolean, slideDirection: string) => {
  return (
    <div
      className={classNames(
