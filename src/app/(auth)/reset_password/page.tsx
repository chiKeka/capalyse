...
const ResetPassword = () => {
  ...
  return (
    <AuthLayout title="Reset Password" sub_caption="Enter your new password below">
      <form className="w-full" onSubmit={handleSubmit(onSubmit)}>
        ...
        />
        {errors.new_password && (
          <div className="text-red-500 text-sm mt-2">{errors.new_password.message}</div>
        )}
        ...
        {errors.confirm_password && (
          <div className="text-red-500 text-sm mt-2">{errors.confirm_password.message}</div>
        )}
