    ...
    >
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="w-full">
          ...
          {errors.otp && (
            <div className="text-red-500 text-sm mt-2 text-center">{errors.otp.message}</div>
          )}

          {errors.root && (
            <div className="text-red-500 text-sm mt-2 text-center">{errors.root.message}</div>
          )}
        </div>
        ...
        <div className="w-full text-sm mx-auto mt-10 text-center">
          ...
          in <span className="text-[#DC2626] font-bold">{formatTime(countdown)}</span>
        </div>
      </form>
    </AuthLayout>
  );
